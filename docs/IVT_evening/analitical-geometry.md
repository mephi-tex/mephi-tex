...
- Даны две пересекающиеся прямые, найти прямую, входящую в пучок первых двух и параллельную заданной прямой вне пучка.  
	...
	- Искомая прямая $\ell_{3}$ содержится в пучке. Пучок : $(\alpha A_{1} + \beta A_{2})x + (\alpha B_{1} + \beta B_{2})y + (\alpha C_{1} + \beta C_{2}) = 0 $. По условию задачи : $\frac{A_{3}}{A_{0}} = \frac{B_{3}}{B_{2}} \neq \frac{C_{3}}{C_{0}} \implies \frac{\alpha A_{1} + \beta B_{2}}{A_{0}} = \frac{\alpha B_{1} + \beta B_{2}}{B_{0}} \implies (\alpha A_{1} + \beta B_{2})B_{0} = (\alpha B_{1} + \beta B_{2})A_{0} \implies \alpha(A_{1}B_{0} - B_{1}A_{0}) = \beta(B_{2}A_{0} - A_{2}B_{0})$  
	- Пусть $\alpha \neq 0$, тогда $\beta = \frac{A_{1}B_{0} - B_{1}A_{0}}{B_{2}A_{0} - A_{2}B_{0}}$  
...
4. $A = B = 0 : Cz + D = 0, z = - \frac{D}{C}, z = const$ (Плоскость, параллельная $Oxy$, $z = 0$ - уравнение $Oxy$)  

### Уравнение плоскости в отрезках на координатных осях  
- $Ax + By + Cz + D = 0 | \cdot (- \frac{1}{D})$  
- $\frac{Ax}{-D} + \frac{By}{-D} + \frac{Cz}{-D} = 1$. Обозначим $\frac{A}{-D} = a, \frac{B}{-D} = b, \frac{C}{-D} = c$  
- $ax + by + cz = 1$  
...
- $\cos\phi = \frac{(\vec{N_{1}}, \vec{N_{2}})}{|\vec{N_{1}}||\vec{N_{2}}|}$  
...
- $\underbrace{\frac{A}{\sqrt{A^{2} + B^{2} + C^{2}}}}_{\cos{\alpha}}x + \underbrace{\frac{B}{\sqrt{A^{2} + B^{2} + C^{2}}}}_{\cos{\beta}}y +  \underbrace{\frac{C}{\sqrt{A^{2} + B^{2} + C^{2}}}}_{\cos{\beta}}z + \frac{D}{\sqrt{A^{2} + B^{2} + C^{2}}} = 0$  
