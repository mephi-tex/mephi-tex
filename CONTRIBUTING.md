...
3. Новые разделы создаются для каждого факультета/направления отдельно. Если вы с иикс пми/пи/ивт/*направление нейм*. То нужно создать раздел ИИКС/*направление нейм*, куда вы будете коммитить информацию с лекций/семинаров.
